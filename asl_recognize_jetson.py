...
class TensorRTONNXRuntime:
    ...
    def infer(self, input_array: np.ndarray) -> np.ndarray:
        ...
        inp = self.inputs[0]
        # Flatten to 1D to match allocated buffer size
...
class ASLLetterRecognizerLite:
    ...
    def extract_static_features(self, hand_landmarks) -> Optional[np.ndarray]:
        ...
        # Apply training normalization (same as original TFLite model)
    ...
    def run_recognition(self, camera_id: int = 0):
        ...
        print("\n" + "="*70)
        print("ASL LETTER RECOGNITION - TensorRT (JETSON OPTIMIZED)")
        print("="*70)
